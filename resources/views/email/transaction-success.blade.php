                          ...
                          <tbody>
                            <tr>
                              <td style="width:150px;">
                                <img alt="Logo" height="auto" src="{{ url ('frontend/images/unknown.png') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="150" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Playfair Display, Times New Roman, serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#071c4d;">Don't Forget Your Invoice!</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                ...
                                src="{{ url ($data -> competition_category->galleries[0]->image) }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">Hi, {{$data->user->name}}<br /><br /> Terimakasih telah bergabung bersama kami dalam trip kali ini<br />Booking ID <strong>#{{ $data->id }}</strong></div>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <td style="border-bottom:1px dashed #eee;vertical-align:middle;padding-bottom:30px;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071c4d;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:16px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                  <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td style="text-align: right">{{ $item->institute }}</td>
                                  </tr>
                                  @endforeach
                                </table>
                              </td>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071c4d;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:16px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                  <tr>
                                    <td colspan="3">Detail Paket Travel</td>
                                  </tr>
                                  <tr>
                                    <td><strong>Paket travel</strong></td>
                                    <td style="text-align: right">{{ $data->competition_category->title }}</td>
                                  </tr>
                                  <tr>
                                    <td><strong>Date</strong></td>
                                    <td style="text-align: right">{{ $data->competition_category->departure_date }}</td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
        ...
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:20px;padding-top:0px;text-align:center;">
                    ...
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            <td style="width: 50px">
                              <img src="{{ url ('frontend/images/support.png') }}" width="35px" />
                            </td>
                            <td style="
                font-size: 16px;
                padding-left: 10px;
              ...
              "> travelucard@gmail.com <br /> 021-2561-987 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#888b93;">2022 Travelucard Copyright All Rights Reserved.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
