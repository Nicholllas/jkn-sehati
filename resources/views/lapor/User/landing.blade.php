...
@section('content')
    ...
    <div class="text-center">
        <h2 class="medium text-white mt-3">Kanal Pengaduan Layanan JKN</h2>
        <p class="italic text-white mb-5">Sampaikan laporan Anda langsung kepada kami</p>
        <p class="italic text-white mb-2">Harap masuk sebelum menulis laporan</p>
    </div>
...
<div class="pengaduan mt-5">
    <div class="bg-purple">
        <div class="text-center">
            <h5 class="medium text-white mt-3">JUMLAH ADUAN YANG MASUK</h5>
