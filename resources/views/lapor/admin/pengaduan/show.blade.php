                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <th>Nama FKTP</th>
                                <td>:</td>
                                <td>{{ $pengaduan->faskes_category->title }}</td>
                            </tr>
                            <tr>
                                <th>Isi Laporan</th>
                                <td>:</td>
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>{{ Carbon\Carbon::parse($pengaduan->tgl_kejadian)->format('d-M-Y') }}
                                </td>
                            </tr>
                ...
                <div class="card-body">
                    <form action="{{ route('tanggapan.createOrUpdate') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="tanggapan" id="tanggapan" rows="4" class="form-control" placeholder="Belum ada tanggapan">{{ $tanggapan->tanggapan ?? '' }}
                            </textarea>
                            @if (session('error'))
