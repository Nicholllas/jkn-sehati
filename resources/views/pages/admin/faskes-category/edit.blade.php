...
@section('title','Edit Profil Faskes')
@section('content')
    <!-- Begin Page Content -->
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Faskes {{ $item->title }}</h1>
    </div>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('faskes-category.update', $item->id) }}" method="POST">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="kode_fktp">Kode Faskes</label>
                <input type="text" class="form-control" name="kode_fktp" placeholder="Masukan Kode FKTP" value="{{ $item->kode_fktp }}">
            </div>
            <div class="form-group">
                <label for="jenis_faskes">Edit Jenis Faskes</label>
                <select id="jenis_faskes"  class="form-control" name="jenis_faskes" value="{{$item->jenis_faskes}}" required autocomplete="jenis_faskes" autofocus>
                                    <option value="{{ $item->jenis_faskes }}" selected>{{ $item->jenis_faskes }}</option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" placeholder="Masukan Nama Faskes" value="{{ $item->title }}">
            </div>
            <div class="form-group">
                <label for="service_hour">Jam Pelayanan</label>
                <input type="text" class="form-control" name="service_hour" placeholder="Masukan Jam Pelayanan" value="{{ $item->service_hour }}">
            </div>
            <div class="form-group">
                <label for="about">Deskripsi Faskes</label>
                <textarea name="about" placeholder="Ketik Deskripsi Faskes" rows="10" class="d-block w-100 form-control">{{ $item->about}}</textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="address" placeholder="Masukan Alamat Faskes" value="{{$item->address}}">
            </div>
            <div class="form-group">
                <label for="no_telp">No Telepon</label>
                <input type="text" class="form-control" name="no_telp" placeholder="Masukan No Telepon" value="{{$item->no_telp}}">
            </div>
            <div class="form-group">
                <label for="perawat">Perawat/Suster</label>
                <input type="number" class="form-control" name="perawat" placeholder="Masukan Jumlah Perawat atau Suster (Ketik 0 jika data tidak ada)" value="{{$item->perawat}}">
            </div>
            <div class="form-group">
                <label for="dokter_umum">Dokter Umum</label>
                <input type="number" class="form-control" name="dokter_umum" placeholder="Masukan Jumlah Dokter Umum" value="{{$item->dokter_umum}}">
            </div>
            <div class="form-group">
                <label for="dokter_gigi">Dokter Gigi</label>
                <input type="number" class="form-control" name="dokter_gigi" placeholder="Masukan Jumlah Dokter Gigi" value="{{$item->dokter_gigi}}">
            </div>

            <div class="form-group">
                <label for="rating">Nilai WTA</label>
                <input type="text" class="form-control" name="rating" placeholder="Masukan Total Nilai WTA" value="{{$item->rating}}">
            </div>
            <div class="form-group">
                <label for="gmap_embed">Link Embed Google</label>
                <input type="text" class="form-control" name="gmap_embed" placeholder="Masukan Link Embed Gmap" value="{{$item->gmap_embed}}">
            </div>
