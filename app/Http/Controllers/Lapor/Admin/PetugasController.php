...
class PetugasController extends Controller
{
    ...
    {
        $petugas = Petugas::all();
        return view('lapor.admin.petugas.index', ['petugas' => $petugas]);
    }

    public function create()
    {
        return view('lapor.admin.petugas.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        notify()->success('Berhasil Menambahkan Petugas !');
    ...
    public function edit($id_petugas)
    {
        ...
        return view('lapor.admin.petugas.edit', ['petugas' => $petugas]);
    }
    ...
    public function update(Request $request, $id_petugas)
    {
        ...
        notify()->success('Berhasil Update Petugas !');
        return redirect()->route('petugas.index');
    }
    ...
    public function destroy($id_petugas)
    {
        ...
        if (!$tanggapan) {
            $petugas->delete();
            notify()->success('Berhasil Delete Petugas !');
            return redirect()->route('petugas.index');
        } else {
